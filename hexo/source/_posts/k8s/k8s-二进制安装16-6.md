...
![1584510914427](k8s-二进制安装16-6/1584510914427.png)
...
参考 浏览器访问kube-apiserver安全端口，创建和导入相关证书，然后访问上面的 10250 端口；
...
```sh
$ kubectl -it exec dnsutils-ds-8zdqv nslookup kubernetes
```

![1584521617687](k8s-二进制安装16-6/1584521617687.png)

```sh
$ kubectl -it exec dnsutils-ds-8zdqv nslookup www.baidu.com
```

![1584521667722](k8s-二进制安装16-6/1584521667722.png)

```
$ kubectl -it exec dnsutils-ds-8zdqv nslookup www.baidu.com.
```

![1584521733375](k8s-二进制安装16-6/1584521733375.png)

```
$ kubectl -it exec dnsutils-ds-7h9np nslookup my-nginx
```

![1584521777488](k8s-二进制安装16-6/1584521777488.png)
...
![screenshot_20200319_100347](k8s-二进制安装16-6/screenshot_20200319_100347.png)
...
![1584688198024](k8s-二进制安装16-6/1584688198024.png)
...
![monitoring_architecture.png](k8s-二进制安装16-6/monitoring_architecture.png)图片 - monitoring_architecture.png
...
```sh
export NODE_IP=192.168.220.100 # 当前部署 harbor 的节点 IP
```
...
```bash
wget  --continue https://storage.googleapis.com/harbor-releases/release-1.7.5/harbor-offline-installer-v1.7.5.tgz
tar -xzvf harbor-offline-installer-v1.7.5.tgz
```
...
![1585292175510](k8s-二进制安装16-6/1585292175510.png)
...
```bash
sudo mkdir -p /etc/docker/certs.d/192.168.220.101
sudo cp /etc/kubernetes/cert/ca.pem /etc/docker/certs.d/192.168.220.101/ca.crt
```
